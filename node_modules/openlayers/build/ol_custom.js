...
ey.prototype.b=function(a){var b=l(a)?na(a).toString():"";if(b in this.g)return this.g[b];a=ey.K.b.call(this,a);if(2==this.state){if(256==a.width&&256==a.height)return this.g[b]=a;var c=lg(256,256);c.drawImage(a,0,0);return this.g[b]=c.canvas}return a};s("BV.animation.bounce",function(a){var b=a.resolution,c=l(a.start)?a.start:ua(),d=l(a.duration)?a.duration:1E3,e=l(a.easing)?a.easing:cf;return function(a,g){if(g.time<c)return g.animate=!0,g.viewHints[0]+=1,!0;if(g.time<c+d){var h=e((g.time-c)/d),m=b-g.viewState.resolution;g.animate=!0;g.viewState.resolution+=h*m;g.viewHints[0]+=1;return!0}return!1}});s("BV.animation.pan",df);s("BV.animation.rotate",ef);s("BV.animation.zoom",ff);s("BV.Attribution",qf);qf.prototype.getHTML=qf.prototype.b;
Cg.prototype.element=Cg.prototype.element;s("BV.Collection",A);A.prototype.clear=A.prototype.clear;A.prototype.extend=A.prototype.je;A.prototype.forEach=A.prototype.forEach;A.prototype.getArray=A.prototype.Hg;A.prototype.item=A.prototype.item;A.prototype.getLength=A.prototype.yb;A.prototype.insertAt=A.prototype.Xc;A.prototype.pop=A.prototype.pop;A.prototype.push=A.prototype.push;A.prototype.remove=A.prototype.remove;A.prototype.removeAt=A.prototype.gd;A.prototype.setAt=A.prototype.si;
s("BV.coordinate.add",vd);s("BV.coordinate.createStringXY",function(a){return function(b){return Dd(b,a)}});s("BV.coordinate.format",zd);s("BV.coordinate.rotate",Bd);s("BV.coordinate.toStringHDMS",function(a){return l(a)?xd(a[1],"NS")+" "+xd(a[0],"EW"):""});s("BV.coordinate.toStringXY",Dd);s("BV.DeviceOrientation",D);D.prototype.getAlpha=D.prototype.e;D.prototype.getBeta=D.prototype.f;D.prototype.getGamma=D.prototype.g;D.prototype.getHeading=D.prototype.i;D.prototype.getTracking=D.prototype.d;
D.prototype.setTracking=D.prototype.b;s("BV.easing.easeIn",function(a){return Math.pow(a,3)});s("BV.easing.easeOut",$e);s("BV.easing.inAndOut",af);s("BV.easing.linear",bf);s("BV.easing.upAndDown",cf);s("BV.extent.boundingExtent",Rd);s("BV.extent.buffer",Vd);s("BV.extent.containsCoordinate",function(a,b){return a[0]<=b[0]&&b[0]<=a[2]&&a[1]<=b[1]&&b[1]<=a[3]});s("BV.extent.containsExtent",Yd);s("BV.extent.createEmpty",Sd);s("BV.extent.equals",ae);s("BV.extent.extend",be);
s("BV.extent.getBottomLeft",he);s("BV.extent.getBottomRight",ie);s("BV.extent.getCenter",je);s("BV.extent.getHeight",ge);s("BV.extent.getSize",function(a){return[a[2]-a[0],a[3]-a[1]]});s("BV.extent.getTopLeft",le);s("BV.extent.getTopRight",me);s("BV.extent.getWidth",fe);s("BV.extent.intersects",pe);s("BV.extent.isEmpty",ee);s("BV.extent.applyTransform",te);s("BV.Feature",G);G.prototype.clone=G.prototype.clone;G.prototype.getGeometry=G.prototype.J;G.prototype.getId=G.prototype.tf;
G.prototype.getGeometryName=G.prototype.sf;G.prototype.getStyle=G.prototype.Ng;G.prototype.getStyleFunction=G.prototype.Og;G.prototype.setGeometry=G.prototype.Ba;G.prototype.setStyle=G.prototype.i;G.prototype.setId=G.prototype.b;G.prototype.setGeometryName=G.prototype.e;s("BV.FeatureOverlay",bk);bk.prototype.addFeature=bk.prototype.ke;bk.prototype.getFeatures=bk.prototype.Ig;bk.prototype.removeFeature=bk.prototype.cd;bk.prototype.setFeatures=bk.prototype.xc;bk.prototype.setMap=bk.prototype.setMap;
bk.prototype.setStyle=bk.prototype.me;bk.prototype.getStyle=bk.prototype.Jg;bk.prototype.getStyleFunction=bk.prototype.Kg;s("BV.Geolocation",N);N.prototype.getAccuracy=N.prototype.Zd;N.prototype.getAccuracyGeometry=N.prototype.o;N.prototype.getAltitude=N.prototype.q;N.prototype.getAltitudeAccuracy=N.prototype.r;N.prototype.getHeading=N.prototype.D;N.prototype.getPosition=N.prototype.F;N.prototype.getProjection=N.prototype.g;N.prototype.getSpeed=N.prototype.u;N.prototype.getTracking=N.prototype.i;
N.prototype.getTrackingOptions=N.prototype.f;N.prototype.setProjection=N.prototype.l;N.prototype.setTracking=N.prototype.e;N.prototype.setTrackingOptions=N.prototype.k;s("BV.Graticule",Xq);Xq.prototype.getMap=Xq.prototype.Rg;Xq.prototype.getMeridians=Xq.prototype.Bf;Xq.prototype.getParallels=Xq.prototype.Ef;Xq.prototype.setMap=Xq.prototype.setMap;s("BV.has.DEVICE_PIXEL_RATIO",sg);s("BV.has.CANVAS",vg);s("BV.has.DEVICE_ORIENTATION",wg);s("BV.has.GEOLOCATION",xg);s("BV.has.TOUCH",yg);
s("BV.has.WEBGL",Bg);gr.prototype.getImage=gr.prototype.b;s("BV.Kinetic",ps);s("BV.loadingstrategy.all",function(){return[[-Infinity,-Infinity,Infinity,Infinity]]});s("BV.loadingstrategy.bbox",mw);s("BV.loadingstrategy.createTile",function(a){return function(b,c){var d=Qb(a.a,c,0),e=Ys(a,b,d),f=[],d=[d,0,0];for(d[1]=e.a;d[1]<=e.d;++d[1])for(d[2]=e.b;d[2]<=e.c;++d[2])f.push(Xs(a,d));return f}});s("BV.Map",W);W.prototype.addControl=W.prototype.We;W.prototype.addInteraction=W.prototype.Xe;
...
s("BV.Object",pd);pd.prototype.bindTo=pd.prototype.Z;pd.prototype.get=pd.prototype.get;pd.prototype.getKeys=pd.prototype.N;pd.prototype.getProperties=pd.prototype.R;pd.prototype.set=pd.prototype.set;pd.prototype.setProperties=pd.prototype.L;pd.prototype.unbind=pd.prototype.Y;pd.prototype.unbindAll=pd.prototype.$;s("BV.Observable",ld);ld.prototype.dispatchChangeEvent=ld.prototype.n;ld.prototype.getRevision=ld.prototype.A;ld.prototype.on=ld.prototype.t;ld.prototype.once=ld.prototype.B;
ld.prototype.un=ld.prototype.v;ld.prototype.unByKey=ld.prototype.C;s("BV.inherits",t);s("BV.Overlay",Z);Z.prototype.getElement=Z.prototype.i;Z.prototype.getMap=Z.prototype.e;Z.prototype.getOffset=Z.prototype.f;Z.prototype.getPosition=Z.prototype.l;Z.prototype.getPositioning=Z.prototype.g;Z.prototype.setElement=Z.prototype.Nd;Z.prototype.setMap=Z.prototype.setMap;Z.prototype.setOffset=Z.prototype.k;Z.prototype.setPosition=Z.prototype.o;Z.prototype.setPositioning=Z.prototype.q;
fr.prototype.getTileCoord=fr.prototype.i;s("BV.View",z);z.prototype.constrainCenter=z.prototype.g;z.prototype.constrainResolution=z.prototype.constrainResolution;z.prototype.constrainRotation=z.prototype.constrainRotation;z.prototype.getCenter=z.prototype.a;z.prototype.calculateExtent=z.prototype.D;z.prototype.getProjection=z.prototype.F;z.prototype.getResolution=z.prototype.b;z.prototype.getResolutionForExtent=z.prototype.i;z.prototype.getRotation=z.prototype.e;z.prototype.getZoom=z.prototype.Of;
z.prototype.fitExtent=z.prototype.Yd;z.prototype.fitGeometry=z.prototype.lf;z.prototype.centerOn=z.prototype.ff;z.prototype.rotate=z.prototype.rotate;z.prototype.setCenter=z.prototype.Ka;z.prototype.setResolution=z.prototype.d;z.prototype.setRotation=z.prototype.q;z.prototype.setZoom=z.prototype.Q;s("BV.webgl.Context",Mv);Mv.prototype.getGL=Mv.prototype.Mh;Mv.prototype.useProgram=Mv.prototype.Fd;s("BV.tilegrid.TileGrid",Vs);Vs.prototype.getMaxZoom=Vs.prototype.Oc;Vs.prototype.getMinZoom=Vs.prototype.Pc;
Vs.prototype.getOrigin=Vs.prototype.mb;Vs.prototype.getResolution=Vs.prototype.fa;Vs.prototype.getResolutions=Vs.prototype.fd;Vs.prototype.getTileSize=Vs.prototype.ia;s("BV.tilegrid.WMTS",$x);$x.prototype.getMatrixIds=$x.prototype.i;s("BV.tilegrid.XYZ",Mw);s("BV.tilegrid.Zoomify",cy);s("BV.style.Circle",Ki);Ki.prototype.getAnchor=Ki.prototype.Pb;Ki.prototype.getFill=Ki.prototype.wh;Ki.prototype.getImage=Ki.prototype.sc;Ki.prototype.getOrigin=Ki.prototype.Wb;Ki.prototype.getRadius=Ki.prototype.xh;
Ki.prototype.getSize=Ki.prototype.lb;Ki.prototype.getStroke=Ki.prototype.yh;s("BV.style.Fill",Hi);Hi.prototype.getColor=Hi.prototype.c;s("BV.style.Icon",Rn);Rn.prototype.getAnchor=Rn.prototype.Pb;Rn.prototype.getImage=Rn.prototype.sc;Rn.prototype.getOrigin=Rn.prototype.Wb;Rn.prototype.getSrc=Rn.prototype.zh;Rn.prototype.getSize=Rn.prototype.lb;Ii.prototype.getRotation=Ii.prototype.l;Ii.prototype.getScale=Ii.prototype.k;s("BV.style.Stroke",Ji);Ji.prototype.getColor=Ji.prototype.Ah;
Ji.prototype.getLineCap=Ji.prototype.xf;Ji.prototype.getLineDash=Ji.prototype.Bh;Ji.prototype.getLineJoin=Ji.prototype.yf;Ji.prototype.getMiterLimit=Ji.prototype.Cf;Ji.prototype.getWidth=Ji.prototype.Ch;s("BV.style.Style",Li);Li.prototype.getFill=Li.prototype.Dh;Li.prototype.getImage=Li.prototype.Eh;Li.prototype.getStroke=Li.prototype.Fh;Li.prototype.getText=Li.prototype.Gh;Li.prototype.getZIndex=Li.prototype.Nf;s("BV.style.Text",Un);Un.prototype.getFont=Un.prototype.rf;Un.prototype.getFill=Un.prototype.Hh;
Un.prototype.getRotation=Un.prototype.Ih;Un.prototype.getScale=Un.prototype.Jh;Un.prototype.getStroke=Un.prototype.Kh;Un.prototype.getText=Un.prototype.Lh;Un.prototype.getTextAlign=Un.prototype.Hf;Un.prototype.getTextBaseline=Un.prototype.If;s("BV.Sphere",ue);s("BV.source.BingMaps",Nw);s("BV.source.BingMaps.TOS_ATTRIBUTION",Ow);s("BV.source.Cluster",Pw);ox.prototype.readFeatures=ox.prototype.a;s("BV.source.GeoJSON",qx);s("BV.source.GPX",rx);s("BV.source.IGC",sx);s("BV.source.ImageCanvas",tx);
s("BV.source.ImageMapGuide",ux);ux.prototype.getParams=ux.prototype.D;ux.prototype.updateParams=ux.prototype.Q;s("BV.source.ImageStatic",vx);s("BV.source.ImageVector",wx);wx.prototype.getSource=wx.prototype.jh;s("BV.source.ImageWMS",yx);yx.prototype.getGetFeatureInfoUrl=yx.prototype.mh;yx.prototype.getParams=yx.prototype.nh;yx.prototype.getUrl=yx.prototype.oh;yx.prototype.setUrl=yx.prototype.ph;yx.prototype.updateParams=yx.prototype.qh;s("BV.source.KML",Cx);s("BV.source.MapQuest",Ix);
s("BV.source.OSM",Ex);s("BV.source.OSM.DATA_ATTRIBUTION",Gx);s("BV.source.OSM.TILE_ATTRIBUTION",Hx);s("BV.source.OSMXML",Lx);s("BV.source.ServerVector",Mx);Mx.prototype.readFeatures=Mx.prototype.a;Ss.prototype.getAttributions=Ss.prototype.U;Ss.prototype.getLogo=Ss.prototype.S;Ss.prototype.getProjection=Ss.prototype.V;Ss.prototype.getState=Ss.prototype.W;s("BV.source.Stamen",Px);s("BV.source.StaticVector",$);s("BV.source.TileDebug",Sx);s("BV.source.TileImage",Kw);Kw.prototype.getTileLoadFunction=Kw.prototype.Ra;
Kw.prototype.getTileUrlFunction=Kw.prototype.Sa;Kw.prototype.setTileLoadFunction=Kw.prototype.Ua;Kw.prototype.setTileUrlFunction=Kw.prototype.ha;s("BV.source.TileJSON",Tx);dt.prototype.getTileGrid=dt.prototype.wa;s("BV.source.TileVector",Ux);s("BV.source.TileWMS",Vx);Vx.prototype.getGetFeatureInfoUrl=Vx.prototype.rh;Vx.prototype.getParams=Vx.prototype.sh;Vx.prototype.getUrls=Vx.prototype.Kf;Vx.prototype.setUrl=Vx.prototype.th;Vx.prototype.setUrls=Vx.prototype.re;Vx.prototype.updateParams=Vx.prototype.vh;
s("BV.source.TopoJSON",Zx);s("BV.source.Vector",Qu);Qu.prototype.addFeature=Qu.prototype.za;Qu.prototype.addFeatures=Qu.prototype.pa;Qu.prototype.clear=Qu.prototype.clear;Qu.prototype.forEachFeature=Qu.prototype.Ha;Qu.prototype.forEachFeatureInExtent=Qu.prototype.qa;Qu.prototype.getFeatures=Qu.prototype.ra;Qu.prototype.getFeaturesAtCoordinate=Qu.prototype.va;Qu.prototype.getClosestFeatureToCoordinate=Qu.prototype.Ia;Qu.prototype.getExtent=Qu.prototype.s;Qu.prototype.getFeatureById=Qu.prototype.ua;
Qu.prototype.removeFeature=Qu.prototype.Ma;Su.prototype.feature=Su.prototype.feature;s("BV.source.WMTS",ay);ay.prototype.getDimensions=ay.prototype.e;ay.prototype.updateDimensions=ay.prototype.g;s("BV.source.XYZ",Dx);Dx.prototype.setTileUrlFunction=Dx.prototype.ha;Dx.prototype.setUrl=Dx.prototype.a;s("BV.source.Zoomify",dy);Pi.prototype.vectorContext=Pi.prototype.vectorContext;Pi.prototype.frameState=Pi.prototype.frameState;Pi.prototype.context=Pi.prototype.context;Pi.prototype.glContext=Pi.prototype.glContext;
...
St.prototype.setImageStyle=St.prototype.$b;St.prototype.setTextStyle=St.prototype.Ca;s("BV.proj.common.add",Rt);s("BV.proj.METERS_PER_UNIT",xe);s("BV.proj.Projection",ye);ye.prototype.getCode=ye.prototype.mf;ye.prototype.getExtent=ye.prototype.s;ye.prototype.getUnits=ye.prototype.fh;ye.prototype.getMetersPerUnit=ye.prototype.ae;ye.prototype.getWorldExtent=ye.prototype.Mf;ye.prototype.isGlobal=ye.prototype.rg;ye.prototype.setExtent=ye.prototype.gh;ye.prototype.setWorldExtent=ye.prototype.wi;
s("BV.proj.addEquivalentProjections",Ee);s("BV.proj.addProjection",Ne);s("BV.proj.addCoordinateTransforms",Pe);s("BV.proj.get",Be);s("BV.proj.getTransform",Se);s("BV.proj.transform",function(a,b,c){return Se(b,c)(a)});s("BV.proj.transformExtent",Ue);s("BV.layer.Heatmap",X);X.prototype.getGradient=X.prototype.sa;X.prototype.setGradient=X.prototype.Lb;s("BV.layer.Image",S);s("BV.layer.Layer",P);P.prototype.getSource=P.prototype.na;O.prototype.getBrightness=O.prototype.d;O.prototype.getContrast=O.prototype.e;
...
O.prototype.setOpacity=O.prototype.Q;O.prototype.setSaturation=O.prototype.X;O.prototype.setVisible=O.prototype.ba;s("BV.layer.Group",R);R.prototype.getLayers=R.prototype.Bb;R.prototype.setLayers=R.prototype.aa;s("BV.layer.Tile",T);T.prototype.getPreload=T.prototype.aa;T.prototype.setPreload=T.prototype.oa;T.prototype.getUseInterimTilesOnError=T.prototype.ea;T.prototype.setUseInterimTilesOnError=T.prototype.sa;s("BV.layer.Vector",V);V.prototype.getStyle=V.prototype.ac;
V.prototype.getStyleFunction=V.prototype.Cc;V.prototype.setStyle=V.prototype.oa;s("BV.interaction.DoubleClickZoom",nr);s("BV.interaction.DragAndDrop",fs);gs.prototype.features=gs.prototype.features;gs.prototype.file=gs.prototype.file;gs.prototype.projection=gs.prototype.projection;ns.prototype.coordinate=ns.prototype.coordinate;s("BV.interaction.DragBox",os);os.prototype.getGeometry=os.prototype.J;s("BV.interaction.DragPan",ss);s("BV.interaction.DragRotateAndZoom",us);
s("BV.interaction.DragRotate",vs);s("BV.interaction.DragZoom",ws);Tv.prototype.feature=Tv.prototype.feature;s("BV.interaction.Draw",Uv);s("BV.interaction.defaults",Kt);s("BV.interaction.KeyboardPan",Ft);s("BV.interaction.KeyboardZoom",Gt);s("BV.interaction.Modify",dw);s("BV.interaction.MouseWheelZoom",Ht);s("BV.interaction.PinchRotate",It);s("BV.interaction.PinchZoom",Jt);s("BV.interaction.Select",iw);iw.prototype.getFeatures=iw.prototype.eh;iw.prototype.setMap=iw.prototype.setMap;
s("BV.geom.Circle",Zi);Zi.prototype.clone=Zi.prototype.clone;Zi.prototype.getCenter=Zi.prototype.Dd;Zi.prototype.getExtent=Zi.prototype.s;Zi.prototype.getRadius=Zi.prototype.pe;Zi.prototype.getType=Zi.prototype.G;Zi.prototype.setCenter=Zi.prototype.Wg;Zi.prototype.setCenterAndRadius=Zi.prototype.He;Zi.prototype.setRadius=Zi.prototype.vi;s("BV.geom.Geometry",Di);Di.prototype.clone=Di.prototype.clone;Di.prototype.getClosestPoint=Di.prototype.g;Di.prototype.getExtent=Di.prototype.s;
Di.prototype.getType=Di.prototype.G;Di.prototype.applyTransform=Di.prototype.rb;Di.prototype.transform=Di.prototype.f;s("BV.geom.GeometryCollection",aj);aj.prototype.clone=aj.prototype.clone;aj.prototype.getExtent=aj.prototype.s;aj.prototype.getGeometries=aj.prototype.$d;aj.prototype.getType=aj.prototype.G;aj.prototype.setGeometries=aj.prototype.Ie;s("BV.geom.LinearRing",Dj);Dj.prototype.clone=Dj.prototype.clone;Dj.prototype.getArea=Dj.prototype.Zg;Dj.prototype.getCoordinates=Dj.prototype.H;
Dj.prototype.getType=Dj.prototype.G;Dj.prototype.setCoordinates=Dj.prototype.P;s("BV.geom.LineString",H);H.prototype.appendCoordinate=H.prototype.$e;H.prototype.clone=H.prototype.clone;H.prototype.getCoordinateAtM=H.prototype.Xg;H.prototype.getCoordinates=H.prototype.H;H.prototype.getLength=H.prototype.Yg;H.prototype.getType=H.prototype.G;H.prototype.setCoordinates=H.prototype.P;s("BV.geom.MultiLineString",uj);uj.prototype.appendLineString=uj.prototype.af;uj.prototype.clone=uj.prototype.clone;
uj.prototype.getCoordinateAtM=uj.prototype.$g;uj.prototype.getCoordinates=uj.prototype.H;uj.prototype.getLineString=uj.prototype.zf;uj.prototype.getLineStrings=uj.prototype.oc;uj.prototype.getType=uj.prototype.G;uj.prototype.setCoordinates=uj.prototype.P;s("BV.geom.MultiPoint",Aj);Aj.prototype.appendPoint=Aj.prototype.cf;Aj.prototype.clone=Aj.prototype.clone;Aj.prototype.getCoordinates=Aj.prototype.H;Aj.prototype.getPoint=Aj.prototype.Ff;Aj.prototype.getPoints=Aj.prototype.Qc;
Aj.prototype.getType=Aj.prototype.G;Aj.prototype.setCoordinates=Aj.prototype.P;s("BV.geom.MultiPolygon",Pj);Pj.prototype.appendPolygon=Pj.prototype.df;Pj.prototype.clone=Pj.prototype.clone;Pj.prototype.getArea=Pj.prototype.ah;Pj.prototype.getCoordinates=Pj.prototype.H;Pj.prototype.getInteriorPoints=Pj.prototype.wf;Pj.prototype.getPolygon=Pj.prototype.Gf;Pj.prototype.getPolygons=Pj.prototype.Rc;Pj.prototype.getType=Pj.prototype.G;Pj.prototype.setCoordinates=Pj.prototype.P;s("BV.geom.Point",yj);
yj.prototype.clone=yj.prototype.clone;yj.prototype.getCoordinates=yj.prototype.H;yj.prototype.getType=yj.prototype.G;yj.prototype.setCoordinates=yj.prototype.P;s("BV.geom.Polygon",I);I.prototype.appendLinearRing=I.prototype.bf;I.prototype.clone=I.prototype.clone;I.prototype.getArea=I.prototype.bh;I.prototype.getCoordinates=I.prototype.H;I.prototype.getInteriorPoint=I.prototype.vf;I.prototype.getLinearRing=I.prototype.Af;I.prototype.getLinearRings=I.prototype.Nc;I.prototype.getType=I.prototype.G;
I.prototype.setCoordinates=I.prototype.P;s("BV.geom.Polygon.circular",Oj);s("BV.geom.SimpleGeometry",Ri);Ri.prototype.getExtent=Ri.prototype.s;Ri.prototype.getFirstCoordinate=Ri.prototype.Xa;Ri.prototype.getLastCoordinate=Ri.prototype.Ya;Ri.prototype.getLayout=Ri.prototype.Za;s("BV.format.Feature",dk);s("BV.format.GeoJSON",nk);nk.prototype.readFeature=nk.prototype.ob;nk.prototype.readFeatures=nk.prototype.la;nk.prototype.readGeometry=nk.prototype.uc;nk.prototype.readProjection=nk.prototype.ma;
nk.prototype.writeFeature=nk.prototype.md;nk.prototype.writeFeatures=nk.prototype.Ib;nk.prototype.writeGeometry=nk.prototype.Ac;s("BV.format.GML",wl);wl.prototype.readFeatures=wl.prototype.la;wl.prototype.writeFeatures=wl.prototype.Ib;s("BV.format.GPX",zm);zm.prototype.readFeature=zm.prototype.ob;zm.prototype.readFeatures=zm.prototype.la;zm.prototype.readProjection=zm.prototype.ma;zm.prototype.writeFeatures=zm.prototype.Ib;s("BV.format.IGC",kn);kn.prototype.readFeature=kn.prototype.ob;
kn.prototype.readFeatures=kn.prototype.la;kn.prototype.readProjection=kn.prototype.ma;s("BV.format.KML",Vn);Vn.prototype.readFeature=Vn.prototype.ob;Vn.prototype.readFeatures=Vn.prototype.la;Vn.prototype.readName=Vn.prototype.fi;Vn.prototype.readProjection=Vn.prototype.ma;Vn.prototype.writeFeatures=Vn.prototype.Ib;s("BV.format.OSMXML",xp);xp.prototype.readFeatures=xp.prototype.la;xp.prototype.readProjection=xp.prototype.ma;s("BV.format.Polyline",Hp);s("BV.format.Polyline.encodeDeltas",Ip);
s("BV.format.Polyline.decodeDeltas",Kp);s("BV.format.Polyline.encodeFloats",Jp);s("BV.format.Polyline.decodeFloats",Lp);Hp.prototype.readFeature=Hp.prototype.ob;Hp.prototype.readFeatures=Hp.prototype.la;Hp.prototype.readGeometry=Hp.prototype.uc;Hp.prototype.readProjection=Hp.prototype.ma;Hp.prototype.writeGeometry=Hp.prototype.Ac;s("BV.format.TopoJSON",Mp);Mp.prototype.readFeatures=Mp.prototype.la;Mp.prototype.readProjection=Mp.prototype.ma;s("BV.format.WFS",Sp);Sp.prototype.readFeatures=Sp.prototype.la;
Sp.prototype.readTransactionResponse=Sp.prototype.o;Sp.prototype.readFeatureCollectionMetadata=Sp.prototype.k;Sp.prototype.writeGetFeature=Sp.prototype.q;Sp.prototype.writeTransaction=Sp.prototype.r;Sp.prototype.readProjection=Sp.prototype.ma;s("BV.format.WKT",eq);eq.prototype.readFeature=eq.prototype.ob;eq.prototype.readFeatures=eq.prototype.la;eq.prototype.readGeometry=eq.prototype.uc;eq.prototype.writeFeature=eq.prototype.md;eq.prototype.writeFeatures=eq.prototype.Ib;
eq.prototype.writeGeometry=eq.prototype.Ac;s("BV.format.WMSCapabilities",wq);wq.prototype.read=wq.prototype.a;s("BV.events.condition.altKeyOnly",function(a){a=a.a;return a.c&&!a.i&&!a.e});s("BV.events.condition.altShiftKeysOnly",xi);s("BV.events.condition.always",dd);s("BV.events.condition.click",function(a){return a.type==ni});s("BV.events.condition.mouseMove",function(a){return"mousemove"==a.originalEvent.type});s("BV.events.condition.never",cd);s("BV.events.condition.singleClick",yi);
s("BV.events.condition.noModifierKeys",zi);s("BV.events.condition.platformModifierKeyOnly",function(a){a=a.a;return!a.c&&a.i&&!a.e});s("BV.events.condition.shiftKeyOnly",Ai);s("BV.events.condition.targetNotEditable",Bi);s("BV.events.condition.mouseOnly",Ci);s("BV.dom.Input",ii);ii.prototype.getChecked=ii.prototype.b;ii.prototype.getValue=ii.prototype.d;ii.prototype.setValue=ii.prototype.f;ii.prototype.setChecked=ii.prototype.e;s("BV.contrBV.Attribution",Bh);Bh.prototype.getCollapsible=Bh.prototype.of;
Bh.prototype.setCollapsible=Bh.prototype.ui;Bh.prototype.setCollapsed=Bh.prototype.ti;Bh.prototype.getCollapsed=Bh.prototype.nf;s("BV.contrBV.Control",Sg);Sg.prototype.getMap=Sg.prototype.d;Sg.prototype.setMap=Sg.prototype.setMap;s("BV.contrBV.defaults",Hh);s("BV.contrBV.FullScreen",Mh);s("BV.contrBV.MousePosition",C);C.prototype.getCoordinateFormat=C.prototype.g;C.prototype.getProjection=C.prototype.k;C.prototype.setMap=C.prototype.setMap;C.prototype.setCoordinateFormat=C.prototype.q;
C.prototype.setProjection=C.prototype.o;s("BV.contrBV.Rotate",Dh);s("BV.contrBV.ScaleLine",Ph);Ph.prototype.getUnits=Ph.prototype.k;Ph.prototype.setUnits=Ph.prototype.o;s("BV.contrBV.Zoom",Fh);s("BV.contrBV.ZoomSlider",ci);s("BV.contrBV.ZoomToExtent",gi);s("BV.color.asArray",Hg);s("BV.color.asString",Jg);pd.prototype.dispatchChangeEvent=pd.prototype.n;pd.prototype.getRevision=pd.prototype.A;pd.prototype.on=pd.prototype.t;pd.prototype.once=pd.prototype.B;pd.prototype.un=pd.prototype.v;
