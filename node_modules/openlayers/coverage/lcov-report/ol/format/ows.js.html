...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/ows.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> ows.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">56.34% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>40/71</span>
      </div>
      <div class='fl pad1y space-right2'>
...
424
425
426</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
 ...
 * @inheritDoc
 */
ol.format.OWS.prototype.readFromDocument = <span class="fstat-no" title="function not covered" >function(doc) {</span>
 ...
 * @inheritDoc
 */
ol.format.OWS.prototype.readFromNode = <span class="fstat-no" title="function not covered" >function(node) {</span>
<span class="cstat-no" title="statement not covered" >  var owsObject = ol.xml.pushParseAndPop({},</span>
      ol.format.OWS.PARSERS_, node, []);
<span class="cstat-no" title="statement not covered" >  return owsObject ? owsObject : null;</span>
};
&nbsp;
&nbsp;
/**
 ...
 */
ol.format.OWS.readAddress_ = <span class="fstat-no" title="function not covered" >function(node, objectStack) {</span>
 ...
 */
ol.format.OWS.readAllowedValues_ = <span class="fstat-no" title="function not covered" >function(node, objectStack) {</span>
<span class="cstat-no" title="statement not covered" >  return ol.xml.pushParseAndPop({},</span>
 ...
 */
ol.format.OWS.readConstraint_ = <span class="fstat-no" title="function not covered" >function(node, objectStack) {</span>
<span class="cstat-no" title="statement not covered" >  var name = node.getAttribute('name');</span>
<span class="cstat-no" title="statement not covered" >  if (!name) {</span>
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
<span class="cstat-no" title="statement not covered" >  return ol.xml.pushParseAndPop({'name': name},</span>
 ...
 */
ol.format.OWS.readContactInfo_ = <span class="fstat-no" title="function not covered" >function(node, objectStack) {</span>
<span class="cstat-no" title="statement not covered" >  return ol.xml.pushParseAndPop({},</span>
 ...
 */
ol.format.OWS.readDcp_ = <span class="fstat-no" title="function not covered" >function(node, objectStack) {</span>
<span class="cstat-no" title="statement not covered" >  return ol.xml.pushParseAndPop({},</span>
 ...
 */
ol.format.OWS.readGet_ = <span class="fstat-no" title="function not covered" >function(node, objectStack) {</span>
<span class="cstat-no" title="statement not covered" >  var href = ol.format.XLink.readHref(node);</span>
<span class="cstat-no" title="statement not covered" >  if (!href) {</span>
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
<span class="cstat-no" title="statement not covered" >  return ol.xml.pushParseAndPop({'href': href},</span>
 ...
 */
ol.format.OWS.readHttp_ = <span class="fstat-no" title="function not covered" >function(node, objectStack) {</span>
<span class="cstat-no" title="statement not covered" >  return ol.xml.pushParseAndPop({}, ol.format.OWS.HTTP_PARSERS_,</span>
      node, objectStack);
};
&nbsp;
&nbsp;
 ...
 */
ol.format.OWS.readOperation_ = <span class="fstat-no" title="function not covered" >function(node, objectStack) {</span>
<span class="cstat-no" title="statement not covered" >  var name = node.getAttribute('name');</span>
<span class="cstat-no" title="statement not covered" >  var value = ol.xml.pushParseAndPop({},</span>
      ol.format.OWS.OPERATION_PARSERS_, node, objectStack);
<span class="cstat-no" title="statement not covered" >  if (!value) {</span>
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
<span class="cstat-no" title="statement not covered" >  var object = /** @type {Object} */</span>
 ...
 */
ol.format.OWS.readOperationsMetadata_ = <span class="fstat-no" title="function not covered" >function(node,</span>
    objectStack) {
<span class="cstat-no" title="statement not covered" >  return ol.xml.pushParseAndPop({},</span>
 ...
 */
ol.format.OWS.readPhone_ = <span class="fstat-no" title="function not covered" >function(node, objectStack) {</span>
<span class="cstat-no" title="statement not covered" >  return ol.xml.pushParseAndPop({},</span>
 ...
 */
ol.format.OWS.readServiceIdentification_ = <span class="fstat-no" title="function not covered" >function(node,</span>
    objectStack) {
<span class="cstat-no" title="statement not covered" >  return ol.xml.pushParseAndPop(</span>
 ...
 */
ol.format.OWS.readServiceContact_ = <span class="fstat-no" title="function not covered" >function(node, objectStack) {</span>
<span class="cstat-no" title="statement not covered" >  return ol.xml.pushParseAndPop(</span>
 ...
 */
ol.format.OWS.readServiceProvider_ = <span class="fstat-no" title="function not covered" >function(node, objectStack) {</span>
<span class="cstat-no" title="statement not covered" >  return ol.xml.pushParseAndPop(</span>
 ...
 */
ol.format.OWS.readValue_ = <span class="fstat-no" title="function not covered" >function(node, objectStack) {</span>
<span class="cstat-no" title="statement not covered" >  return ol.format.XSD.readString(node);</span>
};
&nbsp;
&nbsp;
/**
